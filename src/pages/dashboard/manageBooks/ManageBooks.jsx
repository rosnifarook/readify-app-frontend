                    ...
                    <tr key={index}>
                      ...
                      <td className="p-4 px-6 space-x-4 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
                        <Link
                          ...
                          className="mr-2 font-medium text-indigo-600 hover:text-indigo-700 hover:underline underline-offset-2"
                        >
                          Edit
                        </Link>
                        <button
                          onClick={() => handleDeleteBook(book._id)}
                          className="px-4 py-1 mr-2 font-medium text-white bg-red-500 rounded-full"
                        >
                          Delete
                        </button>
                      </td>
